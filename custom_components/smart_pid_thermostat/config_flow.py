...
class SmartPIDConfigFlow(config_entries.ConfigFlow, domain=DOMAIN):
    ...
    async def async_step_user(self, user_input=None):
        ...
        if user_input is not None:
            user_input[CONF_SETBACK_ENABLED] = True if user_input[CONF_SETBACK_ENABLED] == "true" else False
        ...
        schema = vol.Schema(
            {
                ...
                vol.Required(CONF_SETBACK_ENABLED, default="true"): SelectSelector(SelectSelectorConfig(options=[
        ...
        schema = vol.Schema(
            {
                ...
                vol.Required(CONF_SETBACK_ENABLED, default="true" if cfg[CONF_SETBACK_ENABLED] else "false"): SelectSelector(SelectSelectorConfig(options=[
                    SelectOptionDict(value="true", label="Enabled"),
                    SelectOptionDict(value="false", label="Disabled"),
                ])),
